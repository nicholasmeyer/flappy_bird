...
IMAGES, SOUNDS, HITMASKS = flappybird_utils.load()
...
class EnvironmentInfo:
    ...
    def __init__(self, vector_observations, reward, local_done):
...
class FlappyEnvironment:
    ...
    def step(self, action):
        ...
        image_data = preprocess_frame(image_data)
        env_info = EnvironmentInfo(image_data, reward, terminal)
        return env_info
